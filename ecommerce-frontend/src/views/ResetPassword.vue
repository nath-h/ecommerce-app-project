  ...
  <main class="wrapper">
    <div class="reset-container">
      <div class="reset-card">
        ...
        <form v-if="step === 1" @submit.prevent="handleVerifyIdentity" class="reset-form">
          ...
          <button type="submit" :disabled="loading || !isStep1Valid" class="reset-button">
            {{ loading ? 'Verifying...' : 'Verify Identity' }}
          </button>
        </form>

        <form v-if="step === 2" @submit.prevent="handleReset" class="reset-form">
          ...
          <div class="button-group">
            <button type="button" @click="goBackToStep1" class="back-button" :disabled="loading">
              Back
            </button>
            <button type="submit" :disabled="loading || !isStep2Valid" class="reset-button">
